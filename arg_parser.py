...
def parse_args():
    ...
    parser.add_argument('--environment', type=int, default=2, help='env_map = {0: Mountaincar, 1: Gridworldv1, 2: Gridworldv2, 3: Gridworld687, 4: Cartpole}] [default: 0]')
    ...
    parser.add_argument('--split_ratio', default=0.5, type=float, help='Split Ratio: train/test [default: 0.5]')
