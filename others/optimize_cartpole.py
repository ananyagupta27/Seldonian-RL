...
#
#
# def CandidateMountaincarPDIS(theta, param=10, verbose=0, multiplier=2):
#     theta = theta.reshape(16, 3)
#     env = Mountaincar()
#     total = 0
#     delta = 0.05
...
#
#
# def CandidateMountaincarIS(theta, param=10, verbose=0, multiplier=2):
#     theta = theta.reshape(16, 3)
#     env = Mountaincar()
#     total = 0
#     delta = 0.05
...
#             s = s_prime
#
#         print("num=", num, "den=", den, "total", total)
#         total += G * num / den
#         norm += num / den
...
#     if g2 >= 0:
#         G += -100000
#     print("G=",G, g2, sample_mean2, std2)
#     return G
#
#
# def CandidateCartpoleIS(theta, param=10, verbose=0, multiplier=2):
#     theta = theta.reshape(256, 2)
#     env = Cartpole()
#     total = 0
#     delta = 0.05
